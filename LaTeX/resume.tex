...
\section{Summary}
\cvitem{}{Innovative Software Developer II with 4+ years architecting full-stack solutions in fintech. Demonstrated excellence in delivering high-impact projects like HSBC acquisition (\$1B+ AUM) and Canada's first FHSA platform. Technical leader experienced in React, Ruby, .NET, AWS, and LLM integrations, with a focus on scalable, accessible solutions.}
